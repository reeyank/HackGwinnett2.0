...
import "../assets/img/products/ship.jpeg";
import "../assets/img/products/astro.jpg";
import "../assets/img/team/avatar2.jpg";
import "../assets/img/team/avatar4.jpg";
import "../assets/img/team/avatar5.jpg";
                ...
                <div className="col mb-5">
                  <div className="card shadow-sm">
                    <div className="card-body px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title">Saftey</h5>
                      <p className="text-muted card-text mb-4">
        ...
        <footer className="bg-dark">
          <div className="container py-4 py-lg-5">
            ...
            <div className="text-muted d-flex justify-content-between align-items-center pt-3">
              <p className="mb-0">Copyright © Webmaster GSMST</p>
