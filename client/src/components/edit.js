...
export default function Edit() {
 ...
 useEffect(() => {
   async function fetchData() {
     ...
     const response = await fetch(`hhttps://webmaster-server.herokuapp.com/record/${params.id.toString()}`);
 ...
 async function onSubmit(e) {
   ...
   await fetch(`https://webmaster-server.herokuapp.com/update/${params.id}`, {
     method: "POST",
